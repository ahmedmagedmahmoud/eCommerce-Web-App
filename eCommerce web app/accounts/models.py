...
class EmailActivationQuerySet(models.query.QuerySet):
    def confirmable(self):
        ...
        return self.filter(
                ...
                timestamp__gt=start_range,  # gt == greater than
                timestamp__lte=end_range  # lte == less than or equal
              )
...
class EmailActivation(models.Model):
    ...
    def send_activation(self):
        if not self.activated and not self.forced_expired:
            if self.key:
                base_url = getattr(settings, 'BASE_URL', 'https://ahmed-ecommerce.herokuapp.com/')
